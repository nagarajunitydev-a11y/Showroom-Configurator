...
export const ClientGridPage = () => {
  ...
  if (isMobileOrTablet) {
    return (
      <div className="min-h-dvh w-full max-w-[100vw] overflow-x-hidden overflow-y-auto touch-scroll bg-[radial-gradient(circle_at_top,_rgba(56,189,248,0.16),transparent_38%),linear-gradient(135deg,_#05070b_0%,_#090b11_55%,_#020304_100%)] p-4 pb-[max(1rem,env(safe-area-inset-bottom))] pt-[max(1rem,env(safe-area-inset-top))] font-sans text-white">
